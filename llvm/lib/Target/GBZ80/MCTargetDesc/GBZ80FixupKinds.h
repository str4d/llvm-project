//===-- GBZ80FixupKinds.h - GBZ80 Specific Fixup Entries ------------*- C++ -*-===//
//
...
#ifndef LLVM_GBZ80_FIXUP_KINDS_H
#define LLVM_GBZ80_FIXUP_KINDS_H
...
///       MCFixupKindInfo Infos[GB::NumTargetFixupKinds]
///       in `GBZ80AsmBackend.cpp`.
enum Fixups {
  /// A 32-bit GBZ80 fixup.
  ...
  ///       The nonmenclature is that GBZ80 branch targets are
...
/// All branch targets in GBZ80 are rightshifted by 1 to take advantage
...
} // end of namespace llvm::GBZ80

#endif // LLVM_GBZ80_FIXUP_KINDS_H
